...
// const set = new Set() // time complexity is O(1) is a hash table
// const map = new Map() // time complexity is O(1)  is a hash table
// const arr = [] // time complexity is O(1)
// const obj = {} // time complexity is O(1)
// const str = "" // time complexity is O(1)
// const num = 0 // time complexity is O(1)
// const bool = true // time complexity is O(1)
